...
def create_Request():
    ...
    REQ_avps.append(encodeAVP("User-Name", "giuseppe.demarco@guest.unical.it"))
    REQ_avps.append(encodeAVP("User-Password", PwCrypt("Suk3ll4!",REQ.Authenticator,"Sorch4l8c")))
    REQ_avps.append(encodeAVP("NAS-Identifier", "FBG01"))
    REQ_avps.append(encodeAVP("NAS-IP-Address", "127.0.0.1"))
